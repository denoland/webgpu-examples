...
async function init(device, dimensions, particles, particlesPerGroup) {
	...
	await render(device, dimensions, computePipeline, particleBindGroups, Math.ceil(particles / particlesPerGroup), renderPipeline, particleBuffers, verticesBuffer, particles);
}
let frameNum = 0;
async function render(device, dimensions, computePipeline, particleBindGroups, workGroupCount, renderPipeline, particleBuffers, verticesBuffer, particles) {
